...
$('#startPL').bind('mouseover',function(e){
    if($("#startPL img").attr("state") == "playing"){
        $('#startPL img').attr("src",STATIC_URL+"images/pause_mouse_over.png");
    }else{
        if($("#startPL img").attr("state") == "paused"){
            $('#startPL img').attr("src",STATIC_URL+"images/play_mouse_over.png");
        }
    }
});
...
$('#startPL').bind('mouseleave',function(e){
    if($("#startPL img").attr("state") == "playing"){
        $('#startPL img').attr("src",STATIC_URL+"images/pause.png");
    }else{
        if($("#startPL img").attr("state") == "paused"){
            $('#startPL img').attr("src",STATIC_URL+"images/play.png");
        }
    }
});
...
$('#next').bind('mouseover',function(e){
    $('#next img').attr("src",STATIC_URL+"images/next_mouse_over.png");
});

$('#next').bind('mouseleave',function(e){
    $('#next img').attr("src",STATIC_URL+"images/next.png");
});

$('#revert').bind('mouseover',function(e){
    $('#revert img').attr("src",STATIC_URL+"images/previous_mouse_over.png");
});

$('#revert').bind('mouseleave',function(e){
    $('#revert img').attr("src",STATIC_URL+"images/previous.png");
});
